...
class __Mustache_ed6b2fecb0dd9d0a1f7afc1201fc0c97 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAeab526a3c7140082f260f556b8ffbd5($context, $indent, $value);
...
';
        // 'hasblocks' section
        $value = $context->find('hasblocks');
        $buffer .= $this->sectionA6103372d979d2397e0919c12c769fe4($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function sectionAeab526a3c7140082f260f556b8ffbd5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionA6103372d979d2397e0919c12c769fe4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
