...
class __Mustache_be47f73d4687a8cd238f52b91df336d3 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<nav class="fixed-top navbar navbar-light bg-white navbar-expand moodle-has-zindex">
';
        $buffer .= $indent . '
';
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '        <ul class="navbar-nav trema-custom-menu d-none d-md-flex">
';
